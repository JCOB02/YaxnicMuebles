...
const proyectos = [
    ...
    { id: "2", nombre: "Proyecto jpña", descripcion: "hola", categoria: "Cocinas", imagenes: ['yaxnicMuebles/cocinas/cocina1-1.jpg', 'yaxnicMuebles/cocinas/cocina1-2.jpg', 'yaxnicMuebles/cocinas/cocina1-3.jpg']  }, 
    ...
    { id: "4", nombre: "Proyecto Delta", descripcion: "Descripción del Proyecto Delta", categoria: "Puertas", imagenes: ['yaxnicMuebles/puertas/puerta1-1', 'yaxnicMuebles/puertas/puerta1-2', 'yaxnicMuebles/puertas/puerta1-3']  },
...
export default function ProyectosPage({params}: { params: { categoria: string } }) {
    ...
    return (
        <div>
            ...
            <section className='pt-20'>
                <h1 className='text-5xl font-bold text-center mt-8 scroll-animate'>{proyecto[0].categoria}</h1>
                {proyecto.map((p, index) => (
                <Grid container spacing={2} key={index} className="m-10 scroll-animate">
                    {/* Primer elemento - 7 columnas */}
                    <Grid size={8}>
                        <img src={p.imagenes[0]} alt="Proyecto Starbooks" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    </Grid>
                    <Grid size={4}>
