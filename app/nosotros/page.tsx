...
export default function AboutUs() {
  ...
  const philosophy = [
    {
      icon: <TreePine className="h-8 w-8 text-gold" />,
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-16">
        {/* Hero Section */}
        <section className="py-20 bg-gradient-to-br from-wood-light to-wood-medium">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-5xl md:text-6xl font-display font-bold mb-6 text-foreground scroll-animate">
              Nuestra Historia
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto scroll-animate">
              ...
              <div className="space-y-12">
                {timeline.map((item, index) => (
                  <div key={item.year} className={`relative flex items-center ${index % 2 === 0 ? 'md:justify-start' : 'md:justify-end'} scroll-animate`} style={{ animationDelay: `${index * 0.2}s` }}>
                    ...
                    <Card className={`ml-12 md:ml-0 ${index % 2 === 0 ? 'md:mr-8' : 'md:ml-8'} md:w-5/12 border-none shadow-lg`}>
        ...
        <section className="py-20 bg-secondary/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 scroll-animate">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Maestros artesanos y diseñadores apasionados por su trabajo
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {team.map((member, index) => (
                <Card key={member.name} className="text-center border-none shadow-lg scroll-animate" style={{ animationDelay: `${index * 0.2}s` }}>
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-2xl font-display font-semibold mb-1 text-foreground">
                      {member.name}
                    </h3>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {philosophy.map((item, index) => (
                <Card key={item.title} className="text-center border-none shadow-lg scroll-animate" style={{ animationDelay: `${index * 0.1}s` }}>
                  <CardContent className="p-6">
